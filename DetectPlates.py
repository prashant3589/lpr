...
def detectPlatesInScene(imgOriginalScene):
    ...
    print("height = "+str(height)+" width = "+str(width) +"numchannels ="+str(numChannels))
...
def findPossibleCharsInScene(imgThresh):
    ...
    contours, npaHierarchy = cv2.findContours(imgThreshCopy, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)   # find all contours
